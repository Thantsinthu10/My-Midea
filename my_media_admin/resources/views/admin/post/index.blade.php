            ...
            <div class="card-body">
                <form action="{{ route('admin#createPost') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" value="{{ old('postTitle') }}" name="postTitle" class="form-control" placeholder="Enter post name">
                        @error('postTitle')
                    ...
                    <div class="form-group">
                        <label>Image</label>
                        <input type="file" name="postImage" value="{{ old('postImage') }}" class="form-control" >
                    </div>
                    <div class="form-group">
